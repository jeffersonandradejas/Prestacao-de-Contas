...
receitas_extras_texto = st.text_area(
    "Descreva as receitas extras com valores (Ex.: Multa R$ 50,00; Juros R$ 25,50)"
)
valores_receita_extra = re.findall(r"[\d]+[\.,]\d{2}", receitas_extras_texto)
receitas_extras_total = sum(float(v.replace(",", ".")) for v in valores_receita_extra) if valores_receita_extra else 0.0
...
if st.button("Gerar PDF"):
    ...
    pdf.cell(0, 8, f"{assinante}", ln=True, align="C")
    pdf.cell(0, 8, "Responsável", ln=True, align="C")
